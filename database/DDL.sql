CREATE TABLE AutenticadorUsuario (
    id_autenticador INT PRIMARY KEY IDENTITY(1,1),
...
CREATE TABLE CompraInvitado (
    id_compra_invitado INT PRIMARY KEY IDENTITY(1,1),
    nombre VARCHAR(255) NOT NULL,
    telefono VARCHAR(20),
...
CREATE TABLE PrecioCliente (
    id_precio_cliente INT PRIMARY KEY IDENTITY(1,1),
    nombre_cuenta VARCHAR(255) NOT NULL,
    precio DECIMAL(10, 2) NOT NULL
);

CREATE TABLE CuentaAdmin (
    id_cuenta_admin INT PRIMARY KEY IDENTITY(1,1),
...
CREATE TABLE TipoSuscripcion (
    id_tipo_suscripcion INT PRIMARY KEY IDENTITY(1,1),
    id_precio_cliente INT,
...
CREATE TABLE VentaClienteRegistrado (
    id_venta_cliente_registrado INT PRIMARY KEY IDENTITY(1,1),
    id_cuenta_admin INT,
    id_precio_cliente INT,
    id_autenticador INT,
    id_tipo_pago INT,
...
CREATE TABLE InfoVentasInvitado (
    id_venta_invitado INT PRIMARY KEY IDENTITY(1,1),
    id_cuenta_admin INT,
    id_tipo_pago INT,
    id_no_pedido INT,
...
CREATE TABLE FechasVentasClientes (
    id_fecha_ventas_clientes INT PRIMARY KEY IDENTITY(1,1),
...
CREATE TABLE DetalleInvitado (
    id_detalle_invitado INT PRIMARY KEY IDENTITY(1,1),
