<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
											...
											<div class="card card-flush py-4">
												...
												<div class="card-body pt-0">
													...
													<div class="mb-10 fv-row fv-plugins-icon-container">
														...
														<!--end::Label-->
														<!--begin::Input-->
														<input type="text" name="category_name" class="form-control mb-2" placeholder="Nombre del producto" value="">
														<!--end::Input-->
														<!--begin::Description-->
											...
											<div class="card card-flush py-4">
												...
												<div class="card-body pt-0">
													...
													<div class="mb-10">
														...
														<!--end::Input-->
														<!--begin::Description-->
														<div class="text-muted fs-7">Establezca un título de meta etiqueta. Se recomienda que sean palabras clave simples y precisas.</div>
														<!--end::Description-->
													</div>
													<!--end::Input group-->
													<!--begin::Input group-->
													<div class="mb-10">
														...
														<!--end::Editor-->
														<!--begin::Description-->
														<div class="text-muted fs-7">Establezca una descripción de meta etiqueta para la categoría y aumentar la clasificación SEO.</div>
														<!--end::Description-->
													</div>
													<!--end::Input group-->
													<!--begin::Input group-->
            ...
            <span contenteditable="" tabindex="0" data-placeholder="​" aria-placeholder="" class="tagify__input" role="textbox" aria-autocomplete="both" aria-multiline="false"></span>
                ​
														...
														<!--end::Editor-->
														<!--begin::Description-->
														<div class="text-muted fs-7">Establezca una lista de palabras clave con las que está relacionada la categoría. Separe las palabras clave agregando una coma
